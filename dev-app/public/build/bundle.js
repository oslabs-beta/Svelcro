...
var app = (function () {
    ...
    const file$a = "src/components/ComponentHierarchy.svelte";
    ...
    const file$9 = "src/components/ComponentStats.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 7, 0, 158);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ ComponentHierarchy, ComponentStats });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-2yxpm2");
    			add_location(h1, file, 6, 1, 94);
    			attr_dev(main, "class", "svelte-2yxpm2");
