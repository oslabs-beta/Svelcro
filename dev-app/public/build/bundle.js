...
var app = (function () {
    ...
    const update$1 = (source) => {
        ...
        const treeRender = (data, d3, viewsRoot) => {
          const margin = {
    ...
    var d3TreeRender = /*#__PURE__*/Object.freeze({
        __proto__: null,
        update: update$1,
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 4, 0, 68);
    		},
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ d3TreeRender });
    	return [];
    }
    ...
    for (var i$1$1 = 0; i$1$1 < CATEGORY.length; i$1$1++) {
        switch (true) {
            case isWhiteSpace(i$1$1):
                CATEGORY[i$1$1] = charCodeCategory.WhiteSpace;
                break;

            case isDigit(i$1$1):
                CATEGORY[i$1$1] = charCodeCategory.Digit;
                break;

            case isNameStart(i$1$1):
                CATEGORY[i$1$1] = charCodeCategory.NameStart;
                break;

            case isNonPrintable(i$1$1):
                CATEGORY[i$1$1] = charCodeCategory.NonPrintable;
                break;

            default:
                CATEGORY[i$1$1] = i$1$1 || charCodeCategory.Eof;
        }
    }
    ...
    const diagonal = (s, d) => {
      ...
      const chartRender = (template, d3, chartRoot, templateStructured, collapse) => {
        let root = template;
        const margin = {
      ...
      const collapse$1 = (d) => {
        if (d.children) {
          d._children = d.children;
          d._children.forEach(collapse$1);
          d.children = null;
        }
      };

    var d3ChartRender = /*#__PURE__*/Object.freeze({
        __proto__: null,
        diagonal: diagonal,
        click: click,
        update: update,
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div10 = element("div");
    			div0 = element("div");
    			div0.textContent = "Please refresh your Svelte application";
    			t1 = space();
    			div9 = element("div");
    			div8 = element("div");
    			div7 = element("div");
    			...
    			div5 = element("div");
    			div4 = element("div");
    			attr_dev(div0, "id", "refresh");
    			attr_dev(div0, "class", "svelte-37daxc");
    			add_location(div0, file$9, 501, 8, 17480);
    			attr_dev(div1, "class", "svelte-37daxc");
    			add_location(div1, file$9, 507, 18, 17724);
    			attr_dev(div2, "class", "svelte-37daxc");
    			add_location(div2, file$9, 506, 16, 17700);
    			attr_dev(div3, "class", "svelte-37daxc");
    			add_location(div3, file$9, 505, 14, 17678);
    			attr_dev(div4, "class", "svelte-37daxc");
    			add_location(div4, file$9, 512, 18, 17836);
    			attr_dev(div5, "class", "svelte-37daxc");
    			add_location(div5, file$9, 511, 16, 17812);
    			attr_dev(div6, "class", "svelte-37daxc");
    			add_location(div6, file$9, 510, 14, 17790);
    			attr_dev(div7, "class", "svelte-37daxc");
    			add_location(div7, file$9, 504, 12, 17658);
    			attr_dev(div8, "class", "ldio-qgqa75k37hd svelte-37daxc");
    			add_location(div8, file$9, 503, 10, 17615);
    			attr_dev(div9, "class", "loadingio-spinner-interwind-cjqvhe7g9xe svelte-37daxc");
    			add_location(div9, file$9, 502, 8, 17551);
    			attr_dev(div10, "id", "load-screen");
    			attr_dev(div10, "class", "svelte-37daxc");
    			add_location(div10, file$9, 500, 6, 17449);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$a(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*refreshPage*/ ctx[0] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			button1.textContent = "Chart";
    			t3 = space();
    			button2 = element("button");
    			button2.textContent = "Raw";
    			t5 = space();
    			if (if_block) if_block.c();
    			add_location(button0, file$9, 495, 4, 17245);
    			add_location(button1, file$9, 496, 4, 17304);
    			add_location(button2, file$9, 497, 4, 17365);
    			attr_dev(div, "id", "views-navbar");
    			attr_dev(div, "class", "svelte-37daxc");
    			add_location(div, file$9, 494, 2, 17217);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	const backgroundPageConnection = chrome.runtime.connect({ name: "panel" });
    	...
    	backgroundPageConnection.onMessage.addListener(() => {
    		getData("tree");
    		$$invalidate(0, refreshPage = false);
    	});
    	...
    	const getData = tab => {
    		...
    		const createNode = ast => {
    			...
    			ast.instance.content.body.forEach(el => {
    				...
    				if (el.type === "ImportDeclaration" && el.source.value.includes(".svelte")) {
    					const componentName = `<${el.source.value.slice(2, el.source.value.length - 7)} />`;
    					dependencies[componentName] = {};
    				} else // Find props (via export statements) of current svelte component/file and store the props in the node for said svelte component/file
    			...
    			walk(ast, {
    				enter(ASTnode, parent, prop, index) {
    					...
    					if (ASTnode.hasOwnProperty("declarations")) {
    						...
    						} else // For variable declarations that have a value that is a primitive data type or is a "Literal"
    						if (ASTnode.declarations[0].init.type === "Literal") {
    							state[ASTnode.declarations[0].id.name] = ASTnode.declarations[0].init.value;
    						} else // For variable declarations that have a value that is a composite data type
    						if (ASTnode.declarations[0].init.type === "ObjectExpression" || ASTnode.declarations[0].init.type === "ArrayExpression") {
    		...
    		const createTree = arr => {
    			for (let j = 0; j < arr.length; j += 1) {
    				...
    				const searchTree = (tree, keyToSearchFor, valToSubstituteIfKeyIsFound) => {
    					for (const key in tree) {
    						...
    						if (Object.keys(tree[key]).length && searchTree(tree[key], keyToSearchFor, valToSubstituteIfKeyIsFound)) {
    							return true;
    						}
    					}
    		...
    		chrome.devtools.inspectedWindow.getResources(resources => {
    			...
    			setTimeout(
    				() => {
    					...
    					let templateStructured = d3.stratify().id(function (d) {
    						return d.child;
    					}).parentId(function (d) {
    					...
    					switch (tab) {
    						case "tree":
    							viewsRoot.innerHTML = "";
    							chartRoot.innerHTML = "";
    							treeRender(templateStructured, d3, viewsRoot);
    							break;
    						case "chart":
    							viewsRoot.innerHTML = "";
    							chartRoot.innerHTML = "";
    							chartRender(template, d3, chartRoot, templateStructured, collapse);
    							break;
    						case "raw":
    							viewsRoot.innerHTML = "";
    							chartRoot.innerHTML = "";
    							...
    							pre.innerHTML = syntaxHighlight$1(prettyJSON);
    	...
    	Object_1.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<ComponentTree> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => getData('tree');
    	const click_handler_1 = () => getData('chart');
    	const click_handler_2 = () => getData('raw');
    	...
    	$$self.$capture_state = () => ({
    		...
    		d3ChartRender,
    		d3TreeRender,
    		syntaxHighlight: syntaxHighlight$1,
    		refreshPage,
    	...
    	$$self.$inject_state = $$props => {
    		if ('refreshPage' in $$props) $$invalidate(0, refreshPage = $$props.refreshPage);
    	};
    	...
    	return [refreshPage, getData, click_handler, click_handler_1, click_handler_2];
    }
    ...
    // (99:0) <Hidden bind:this={child} on:show={e => child.shown = e.detail}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(99:0) <Hidden bind:this={child} on:show={e => child.shown = e.detail}>",
    		ctx
    	});
    ...
    // (103:0) <Hidden bind:this={child1} on:show={e => child1.shown = e.detail}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(103:0) <Hidden bind:this={child1} on:show={e => child1.shown = e.detail}>",
    		ctx
    	});
    ...
    // (107:0) <Hidden bind:this={child2} on:show={e => child2.shown = e.detail}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(107:0) <Hidden bind:this={child2} on:show={e => child2.shown = e.detail}>",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	/*hidden0_binding*/ ctx[9](hidden0);
    	hidden0.$on("show", /*show_handler*/ ctx[10]);
    	...
    	/*hidden1_binding*/ ctx[11](hidden1);
    	hidden1.$on("show", /*show_handler_1*/ ctx[12]);
    	...
    	/*hidden2_binding*/ ctx[13](hidden2);
    	hidden2.$on("show", /*show_handler_2*/ ctx[14]);
    	...
    	const block = {
    		c: function create() {
    			...
    			button3.textContent = "Message Test";
    			t7 = space();
    			...
    			add_location(button0, file$1, 91, 2, 2424);
    			attr_dev(button1, "class", "svelte-1ukvu4s");
    			add_location(button1, file$1, 92, 2, 2498);
    			attr_dev(button2, "class", "svelte-1ukvu4s");
    			add_location(button2, file$1, 93, 2, 2572);
    			attr_dev(button3, "id", "connectButton");
    			attr_dev(button3, "class", "svelte-1ukvu4s");
    			add_location(button3, file$1, 94, 2, 2650);
    			attr_dev(nav, "class", "svelte-1ukvu4s");
    			add_location(nav, file$1, 86, 0, 2293);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		d: function destroy(detaching) {
    			...
    			/*hidden0_binding*/ ctx[9](null);
    			destroy_component(hidden0, detaching);
    			if (detaching) detach_dev(t8);
    			/*hidden1_binding*/ ctx[11](null);
    			destroy_component(hidden1, detaching);
    			if (detaching) detach_dev(t9);
    			/*hidden2_binding*/ ctx[13](null);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function updateScript() {
    		mainToBgPort.postMessage({ body: 'runContentScript' });
